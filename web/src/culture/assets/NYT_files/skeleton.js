...
try {
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.4.95.js", main: "static.adsafeprotected.com/main.19.8.34.js"},
		protocol: 'https',
		jsref: "https:\/\/tpc.googlesyndication.com\/safeframe\/1-0-37\/html\/container.html",
		asid: "b855dca7-19d3-11ea-b38b-70106fb515c4",
		...
		mode: "rjss",
		requrl: "",
		dtBaseURL: "https:\/\/dt.adsafeprotected.com\/dt?advEntityId=361276",
		adsafeSrc: "https:\/\/pixel.adsafeprotected.com\/rfw\/st\/361276\/40293755\/skeleton.js",
		tpiLookupURL: "",
		getTpl: "false",
		use100v: false,
		useBapiCallback: "",
		useViewabilityNotification: "",
		scriptUrl: "https:\/\/pixel.adsafeprotected.com\/rjss\/st\/361276\/40293755\/skeleton.js",
		accountForSadImps: '',
		sendCookie: 'true',
		cookieBaseURL: 'sc.iasds01.com\/dtc?advEntityId=361276&pubEnt=40293755',
		fwMonitoring: 'true',
		doNothing: false,
		mn: "app49dal",
		mobOrTab: false,
		app: false,
		mobFwUrl: "https:\/\/mobile.adsafeprotected.com\/internal\/monitoring\/app\/initial\/361276\/40293755\/",
		anId: '',
		advEntityId: '361276',
		pubEntityId: '40293755',
		videoId: '',
		videoChannel: '',
		rts: {},
...
{type:h.DT_CODES.UNLOAD,asION:!0}));return g}function a(a,b,c,d){var q=g(a);l.provide("viewabilityDefinitions",q);return f(q).map(function(q,g){var f;f=new ab(g,b);var v=(new bb(c,a,g.rts)).getCallbacks(),L=new cb(d.createPingJobs(g.type,g.timeInViewThresholds,v,g.metricId));g.rtsCallbacks=v;f=g.thresholdType===h.GROUPM_MOBILE_PASS_THRU_TIME_IN_VIEW_THRESHOLD_TYPE?new db(f,g,L,s.isVideo()):new eb(f,new ca(g.minUnit),L);f.start();return f})}function b(a,b){var c=(new da).accepts(),c=!s.isAvid()&&!c&&
!s.isInMobiMraidVideo();return s.isVideo()&&c?fb(m.videoId,a,b):{}}function c(a,b,c,d,q,p,g,B,v,L){try{m.perf.markStart(oa),m.tpiLookupURL&&gb(g,B).init(m.tpiLookupURL),s.isDomless()||L.isStarted()&&L.sendOriginList(),z.runAll(),r.execAtEndOfThread(function(){var p;try{m.perf.markStart(pa);p={output:(new Date).getTime()-q};a.addItem(p,"sinceFw",{type:h.DT_CODES.ADTALK});f.isDef(b.loopStarted())&&a.addItem({output:b.loopStarted()},"readyFired",{type:h.DT_CODES.ADTALK});m.perf.markEnd(pa);var g,x;m.isSplitMode&&
...
Ib(new E,v.viewabilityMeasurement,v.mBrowser,v.mDataTransfer,v.mFeatures,l,v.iOutput,q,p,v.mVideo));a(v.mFeatures,v.mViewability,n,f);v.loopDelay=ra();v.renderDetector=Jb();v.mDataTransfer.setViewabilityMod(v.mViewability);m.perf.markEnd(qa);return v},preImpression:function(a,b,c,d,q,p,g,f,v,L,R){var D,r,H,A,s;m.perf.markStart(sa);try{c.isApplicable(L)&&(c.start(),d.addItem(c.getFrameMap(),"fm"),v.on("fm2")&&d.addItem(c.getFrameMapIncludingPeerCase(),"fm2"),v.on("idMap")&&(D=c.getIdMap())&&d.addItem(D,
"idMap"))}catch(t){q.add(h.ERROR_CODES.ADTALK_GENERAL)}try{p.isApplicable(g,v,L)&&p.start(),s=f.detectTopURL(),v.on("exch")&&(r=(new Kb).createInstance(q,d),r.parse(s)),H=Lb(),H.isApplicable(v)&&H.start(v),L.usesGroupMCustomMetric()&&Mb(),A=Nb(),A.isApplicable(v)&&(A.start(),l.trigger("sendCookie")),R.start()}catch(U){q.add(h.ERROR_CODES.IMPRESSION_LEADUP)}m.perf.markEnd(sa);return s},sendImpression:function(a,b,c,d,q,p,g,B,v){try{Ob(a,b,c,d,q,p,g).send(B),f.isFunction(v.triggerInitializationEvents)&&
v.triggerInitializationEvents()}catch(h){__IntegralASDiagnosticCall("impsend",h,m)}},postImpression:function(a,b,c,n,q,p,g,f,v,l,r,D,C){try{m.perf.markStart(ta);var H=Pb();H.start();H.addFieldTypes([h.DT_SLOT.IM,h.DT_SLOT.FF,h.DT_SLOT.ENVIRONMENT,h.DT_SLOT.FF_EXP]);var A=Qb(a,b,c);A.isApplicable(n)&&A.start();var s;n.bootstrapOn("getTpl")&&n.on("usetpl")&&(s=Rb(q,p,g,b,f),s.init());d(f,v,l,g,n,q,p,b,D);r&&r.start&&r.start();C.isDomless()||Sb().start(["sca","xsca","rsrch"],n);Tb();z.runTier(h.TIERS.VIEWABILITY);
...
h=function(a){f.isDef(a)&&(u=a);return u},v=function(a,b){return a+"="+f(b).toION()},q=q?q.replace(/&$/,""):"";return{appendToParamValue:function(b,c){var d,e;(d=p[b])?p[b]=d+c:a&&q.length&&(d=q.split(b),e=1<d.length)&&(e=d[1].split("&")[0],d=[d[0],e].join(b),q=q.replace(d,d+c))},fullDom:c,hostname:e,sub:x,master:h,setParam:function(a,b){p[a]=p[a]||{};f(b).isObj()?f(p[a]).mixin(b):p[a]=b},path:function(a){n=a},toString:function(){var a=x()?x()+".":"",b=n?"/"+n:"",c;q||!f(p).isEmpty()?(c=f(p).isEmpty()?
"":f(p).stringify(v,"&"),c="?"+q+(q&&c?"&"+c:c)):c="";return d+"://"+a+h()+b+c}}},Tb=function(){var g=function(a){var c=[];f(a).each(function(a,b){400>=c.concat(b).join("").length&&c.push(b)});return c},a=function(a,c){var d;c&&c.id&&(d=c.id.replace(/[^\w-_.>\/]/g,""));return d};return function(){var b,c;try{if(s.friendly&&!s.isMobileApp())if(b=l.request("adSlotIds"))c=b;else{var d,e;if(d=t.getOurNodeInTop()){var k=t.getAncestorNodes(d);e=f(k).map(a)}if(b=e=e&&g(e))l.trigger("addOutputItem",{output:b},
...
""),e.setAttribute("async",""));f.isDef(c)&&c.appendChild(e)},e=function(a){f.isFunction(a)?a({iasImpId:m.asid}):a&&"string"===typeof a&&(a=(new Q(a,!0)).toString(),c(a,void 0,!0))},k=function(b,c,e,k){d(a.wrap(b,c,e,k))};l.on({addNode:b,send:c,exec:d,notify:e,jsonp:k});return{addNode:b,send:c,exec:d,notify:e,jsonp:k}},hc=function(g){var a=function(a,b){b=b||a;a=1<arguments.length?a:"script";l.request("omidVerificationClient")["script"===a?"injectJavaScriptResource":"sendUrl"](b,function(){})},b=
function(a,b){a=encodeURI(a);l.request("omidVerificationClient").sendUrl(a.toString(),b||function(){})},c=function(a,b){l.request("omidVerificationClient").injectJavaScriptResource(a,b||function(){})},d=function(a){f.isFunction(a)?a({iasImpId:m.asid}):a&&"string"===typeof a&&(a=(new Q(a,!0)).toString(),b(a))},e=function(a,b,d,e){c(g.wrap(a,b,d,e))};l.on({addNode:a,send:b,exec:c,notify:d,jsonp:e});return{addNode:a,send:b,exec:c,notify:d,jsonp:e}},s=function(){var g="undefined"===typeof window,a="undefined"!==
typeof w&&"undefined"!==typeof top&&w!==top,b=function(){var a=!1;if(g)a=!0;else try{a=!!top.document}catch(b){}return a}(),c=function(){return g||f.isDef(r.getWindow().mraid)},d=function(){return!g&&f.isDef(r.getWindow().mraid)},e=function(){var a=!1;if(!g)var b=(a=r.getWindow().inmobi)&&a.IASDocumentVideoBuffer,a=a&&b&&f.isFunction(b.addVideoEventListener),a=d()&&!!a;return a},k=function(){var a;if(!(a=-1!==m.mode.indexOf("jsvid"))){var b;a=!1;var c=z.getAggregator();if(!g&&(c=c.request("avidJsClient"),
c.isAvidAvailable()))try{b=c.getAvidAdSessionContext(),a=b.mediaType===h.MEDIA_TYPE.VIDEO}catch(d){}(b=a)||(c=z.getAggregator(),b=c.request("omidVerificationClient"),a=!1,c=c.request("omidAdSessionContext"),b&&c&&(a=c.mediaType===h.MEDIA_TYPE.VIDEO),b=a||e());a=b}return a},u=function(){return m.mobOrTab},n=function(a){return!1===f(m.customViewability).isArray()?!1:0<f(m.customViewability).filter(function(b,c){return N.contains(c.id,a)}).length},q=function(){return n("grpm")||m.use100v};return{embedded:a,
friendly:b,isFriendlyToParent:function(a){var b,c;if(g)a=!0;else{try{c=Q(a.document.referrer),b=c.hostname===a.location.hostname}catch(d){}a=b}return a},friendlyIframe:a&&b,xDomainIframe:a&&!b,getTagTime:function(){return r.now()-m.birthdate},getPageTime:function(){var a=h.NA;!g&&f.isDef(w.chrome)&&f.isDef(w.chrome.csi)&&f.isFunction(w.chrome.csi)&&(a=r.round(w.chrome.csi().pageT));return a},isVideo:k,isMobileApp:c,isSpecifiedAd:function(){var a=!1;g||(a=(a=m._cl_adpath)&&f.isStr(a));return a},isCompoundAd:function(){var a=
!1,b=/\[(.*)\]/;g||(a=b.exec(m._cl_adpath),a=null!==a&&0!==a[1].length&&1<a[1].split(",").length);return a},isAvid:function(){return!g&&f.isDef(r.getWindow().avid)},isOmid:function(){var a=z.getAggregator().request("omidVerificationClient");return a&&a.isSupported()},isOmidNative:function(){return(new da).accepts()},isOmidForWeb:function(){return(new ya).accepts()},isDomless:function(){return g},isAvidNative:function(){var a=!1,b=z.getAggregator();g||(b=b.request("avidJsClient"),b.isAvidAvailable()&&
(a=b.getAvidAdSessionContext().avidAdSessionType,a=a===h.AVID.AD_SESSION_TYPE.MANAGED_DISPLAY||a===h.AVID.AD_SESSION_TYPE.MANAGED_VIDEO));return a},isBustedIframe:function(){var a=!1;g||(a=void 0!==ga());return a},isMraid:d,isSafeFrame:function(){var a=!1;g||(a=f(r.getWindow().$sf).isObj(!1)&&f(r.getWindow().$sf.ext).isObj(!1));return a},isInMobiMraidVideo:e,isDeviceTypeGroupMobile:u,usesIASFullyInViewCustomMetric:function(){return n("fiv")||m.use100v},usesGroupMCustomMetric:q,isCeltra:function(){var a=
!1;g||(a=za().isApplicable());return a},usesGroupMCustomMetricMobilePassThru:function(){return q()&&u()},usesZeroPivCustomMetric:function(){return!1===f(m.customViewability).isArray()?!1:0<f(m.customViewability).filter(function(a,b){return f(b.thresholds).findFirst(function(a,b){return 0===b.piv})}).length},isRefreshable:function(a){try{var b=r.getTop();window.addEventListener("message",function(b){/isRefreshable/g.test(b.data)&&a(null,b&&b.data)},!1);b.postMessage(JSON.stringify({requestTop:"isRefreshable"}),
"*")}catch(c){a(c)}},isPossiblyRefreshable:function(){return!g&&!c()&&!k()&&a&&"jload"===m.mode}}}(),y={addEvent:function(g,a,b,c){f.isDef(g.addEventListener)?"mouseenter"===a?g.addEventListener("mouseover",y.mouseEnter(b),c):"mouseleave"===a?g.addEventListener("mouseout",y.mouseEnter(b),c):g.addEventListener(a,b,c):f.isDef(g.attachEvent)&&("DOMContentLoaded"===a&&(a="load"),g.attachEvent("on"+a,b))},removeEvent:function(g,a,b){f.isDef(g.removeEventListener)?("mouseenter"===a?(a="mouseover",b=y.mouseEnter):
"mouseleave"===a&&(a="mouseout",b=y.mouseEnter),g.removeEventListener(a,b)):f.isDef(g.detachEvent)&&g.detachEvent("on"+a,b)},mouseEnter:function(g){var a=this;return function(b){var c=b.relatedTarget;this===c||a.isAChildOf(this,c)||g.call(this,b)}},isAChildOf:function(g,a){if(g===a)return!1;for(;a&&a!==g;)a=a.parentNode;return a===g},getStyle:function(g,a,b){var c="",d=M.defaultView&&M.defaultView.getComputedStyle;b=b||"";d?c=(g=M.defaultView.getComputedStyle(g,b))?g.getPropertyValue(a):c:g.currentStyle&&
(a=a.replace(/\-(\w)/g,function(a,b){return b.toUpperCase()}),c=g.currentStyle[a]);return c},getXHR2:function(g,a){var b,c;f.isDef(w.XMLHttpRequest)?(c=new XMLHttpRequest,"withCredentials"in c&&(b=c)):f.isDef(XDomainRequest)&&(b=new XDomainRequest);return b},whenReady:function(g,a){if(s.isDomless())r.setTimeout(function(){g()},50);else{var b=a||(s.xDomainIframe?M:r.getTop().document),c=function(a){var c=r.setInterval(function(){b.body&&(r.clearInterval(c),a())},50)},d=this;(function(a){var k=function(){a(!0)};
...
a===h.DT_CODES.ADTALK||a===h.DT_CODES.SCA||a===h.DT_CODES.XSCA||a===h.DT_CODES.EXTERNAL||a===h.DT_CODES.LARGE_BILLABLE;if(c.impressionIsIdentifiable()&&(s||"n"!==k.getCurrentLoc()))try{var t=m.dtBaseURL,J=new Q(t,!0),w=r.now();l.trigger("preSendDt",a);t||(J.path("dt"),b.on("usedtdomain")&&J.sub("dt"));v(J,a,e);x&&x.field&&J.setParam(x.field,x.value);g||L(J,a);l.trigger("send",J,function(){q+=1;n=r.now()-w;f.isFunction(B)&&B()},u);a===h.DT_CODES.UNLOAD&&(p=!0);d.cleanup()}catch(z){__IntegralASDiagnosticCall("dt-"+
...
(a.flagForRemoval=!0);return c},e);a.setParam("tv",e)},L=function(c,g){var f,p={};d.filterOutput(function(a){return a.standalone&&!a.minDt&&a.type===g},function(a,b){c.setParam(a,b.replace("%3A",":"))});k.fastForward();if(g===h.DT_CODES.CUSTOM||g===h.DT_CODES.UNLOAD||g===h.DT_CODES.VIDEO_EVENTS||g===h.DT_CODES.FULLY_INVIEW||g===h.DT_CODES.PING||g===h.DT_CODES.VIEWABILITY_READY||g===h.DT_CODES.ADTALK)p.clog=u,s.isVideo()&&(f=s.isOmid()&&!s.isOmidForWeb()?"omidVideoEventsString":"videoEventsString",
...
v=l.obstructions,m=v&&0<v.length,s=e.originalAdContainer,t=p.adGeometry,C=p.adFound,H=e.detectionMethod,A=0,x={x:0,y:0,width:x.width,height:x.height},F=u(s,t),K=e.outOfViewReason,w=0,J=0,z=m||!1,w=1>=t.width*t.height;c&&w&&(C=!1,K=K||"",C||-1!==K.indexOf(h.OUT_OF_VIEW_REASONS.GEOM)||(K=h.OUT_OF_VIEW_REASONS.GEOM+(""!==K?"."+K:"")));if(C&&0<e.percentageInView){w=d(x,l,F);m?(A=n(l,F),A=k(x,l,A),A=u(l,A),A=a.calculateObstructedArea(A,v)):A=0;J=A;A=Math.round((w-J)/(F.width*F.height)*100);m&&0===J&&(z=
...
l:I(d)},refresh:function(){R=L=v=B=n=l=void 0;if(k){var a,c;if(!s.isDomless()&&(c=b.parentNode)){for(;b!==w&&c&&c!==M&&!a;)a=c===d,c=c.parentNode;a||(d=b.parentNode)}}},getAdNode:function(){return b},getSliceStatus:function(){var a;p&&p.isReadyToMeasure()?a=p.getSliceStatus():s.friendly&&x&&f.isDef(L)&&(a=x.getSliceStatus(L,v,B,R));return a}}},sd=function(a,b){var c=[],d,e=f([]),k=function(){return c[0]&&c[0].getDetectionMethod()===h.DETECTION_METHODS.AD_PLACEHOLDER},m=function(n,q,p,m){var u=k()||
...
c.scrY):f.isDef(a.mozInnerScreenX)&&(y=r.round(a.mozInnerScreenX),D=r.round(a.mozInnerScreenY));var p={scrX:y,scrY:D,iFrameClippingWidth:C,iFrameClippingHeight:H},A,F,K=b||t.getIeDimObj(a);b=K;f.isDef(a.innerWidth)?(A=a.innerWidth,F=a.innerHeight):K&&f.isDef(K.clientWidth)?(A=K.clientWidth,F=K.clientHeight,0===A&&0<K.offsetWidth&&(A=K.offsetWidth),0===F&&0<K.offsetHeight&&(F=K.offsetHeight)):a.frameElement&&f.isDef(a.frameElement.clientWidth)&&(A=a.frameElement.clientWidth,F=a.frameElement.clientHeight);
...
(r.now()-m.birthdate));m.perf.mark("si");c.on("swapids")?n.push("oid:"+m.oid):n.push("uid:"+d.unq);n.push("v:19.8.34");n.push("sp:"+(m.isSplitMode?1:0));c.on("resolution")&&(n.push("wr:"+f(t.windowSize()).toArray().join(".")),n.push("sr:"+f(t.screenSize()).toArray().join(".")));b=function(){var a;a=String(m.scriptUrl).toLowerCase();var b=a.indexOf("ias_xpc");-1<b?(a=a.substring(b+7+1),b=a.indexOf("&"),a=-1<b?a.substring(0,b):a):a="NotFound";return a||""}();"NotFound"!==b&&n.push("x_xpc:"+b);return n},
